...
function SidebarBtn(props) {
  return (
    <NavLink to={props.location} className='font-semibold border-b-[4px] border-[#ffffff00] bg-transparent hover:bg-[#422FC6] group flex h-8 my-2 w-full items-center py-1'>
