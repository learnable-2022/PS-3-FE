...
function DoughnutChart ({departments, departmentNumbers}) {
  ...
  return (
    <div className='w-full md:w-4/5 h-[90%] md:h-4/5 relative flex justify-center items-center'>
      ...
      <div className='absolute top-[36%] left-[50%] text-center transform -translate-x-1/2 -translate-y-4 md:-translate-y-1/5 text-gray-500' >
        <span className='font-bold text-lg sm:text-3xl md:text-sm'>
          {sum}
        </span>
        <br />
        <p className='text-lg sm:text-3xl md:text-sm font-semibold'>Employees</p>
      </div>
    </div>
  );
}
